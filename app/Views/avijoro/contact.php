      ...
      <div class="contact-main-grid">
        ...
        <div class="contact-sidebar">
          ...
          <div class="contact-info-list">
            ...
            <div class="contact-info-item">
              <div class="contact-icon-circle" style="background-color: #1877F2;">
              ...
              <div class="contact-text-block">
                <h4><?= lang('Texte.contact_facebook_titre') ?></h4>
                <p><?= lang('Texte.contact_facebook_desc') ?></p>
                <a href="<?= esc(FACEBOOK_FUNDRAISING_URL) ?>" target="_blank" rel="noopener" style="display: inline-block; background-color: #1877F2; color: #ffffff; padding: 0.5rem 1.25rem; border-radius: 9999px; text-decoration: none; font-size: 0.85rem; font-weight: 600; margin-top: 0.5rem;">
                  <?= lang('Texte.contact_facebook_btn') ?>
                </a>
              </div>
            </div>
          </div>
            ...
            <div class="contact-footer-row">
              ...
              <div class="contact-social-block">
                ...
                <div class="contact-social-icons">
                  <a href="<?= esc(FACEBOOK_FUNDRAISING_URL) ?>" target="_blank" rel="noopener" class="contact-social-btn"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg></a>
